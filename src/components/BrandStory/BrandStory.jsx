...
const BrandStory = () => {
    ...
    return (
        <div id='brandstory'>
            ...
            >
                <div className="headeri">CHỌN QUÀ NÈ</div>
            </motion.div>
    ...
    textShadow: "-5px 3px 4px rgba(0, 0, 0, 0.431)",
            ...
            {/* <div className="card-effect1">
                <motion.div
                    className="card"
                    initial={{ x: "-15rem", opacity: 0,zIndex: 1}}
                    whileInView={{
                        x: 0,
                        opacity: 1,
                        transition: {
                ...
                <motion.div
                    className="card"
                    initial={{ opacity: 0,  x: "10rem",zIndex: 10  }}
                    whileInView={{
                        opacity: 1,
                        x: 0,
                        rotateZ: 10,
                ...
                <motion.div
                    className="card"
                    initial={{ opacity: 0,  x: "10rem",zIndex: 100  }}
                    whileInView={{
                        opacity: 1,
                        x: 0,
                        rotateZ: 10,
...
{/* <audio id="audio" autoPlay src="/assets/Nhac-Chuong-Giang-Sinh-Khong-Loi-Nhac-Noel-Khong-Loi-Hay.mp3" loop preload="auto" style={{ display: "none" }}></audio> */}
